...
$fields_string_arr['rsvp'] = $_REQUEST['rsvp'];

//Join Group URL
$meetup_url = 'https://api.meetup.com/rsvp';
...
error_log('submit_rsvp_URL:' . $meetup_url . " event_id:" . $fields_string_arr['event_id'] . " , rsvp:" . $fields_string_arr['rsvp'] . " , member_id:" . $member_id);
